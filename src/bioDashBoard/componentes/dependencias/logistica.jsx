...
const Logistica = (props) => {
    ...
    const { setPopUp = console.log, actualizarEstado = console.log, modeloBiosepticos = { vehiculos: [], ...ModeloBiosepticos }, userData = UserObj(), objStrings = objStringsInit, vehiculos = { array: [] }, objCss = objCssInit, showed = 'centro rapido' } = props
