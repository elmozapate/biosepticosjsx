                        ...
                        <>
                            {
                                !creatingObra && !misServicios.array.length > 0 ?
                                    ...
                                    :
                                    <FormularioDatosNuevoServicio setCreatingObra={setCreatingObra} sendData={sendNewServicio} misObras={misObras} userData={userData} setPopUp={setPopUp} sideOpen={sideOpen} activeEmpresa={activeEmpresa} objCss={objCss} objStrings={objStrings} showed={showed} back={setCreatingObra} />
                            }                    </> : <>
                            {
