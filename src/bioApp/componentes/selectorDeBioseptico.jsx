                            ...
                            <div className="container-bio">
                                        ...
                                        return (
                                            <>
                                                <div className="dia" id={`asdsadsa${iS}`}>
                                                    ...
                                                    <p >
                                                        <p className="flex-p-between"><span> SERVICIOS</span>  <span className="gap-min"><span>PENDIENTES : {rutasMias[keyS].servicios.length}</span>{!onMobil.state&&<span>TOTAL : {rutasMias[keyS].servicios.length + rutasMias[keyS].serviciosListos.length}</span>}<span className='pointer' onClick={(e) => { e.preventDefault(); setSelectioned(`${keyS}-SERVICIOS`) }}>ver</span> </span></p>
                                ...
                                <div className="dia" id={`asdsadsadd`}>
                                    ...
                                    {revisarMisRutas(true) &&
                                        ...
                                        <p >
                                            <p className="flex-p-between"><span> SERVICIOS</span>  <span className="gap-min"><span>PENDIENTES : {rutasMias.seleccionado.servicios.length}</span>{!onMobil.state&&<span>TOTAL : {rutasMias.seleccionado.servicios.length + rutasMias.seleccionado.serviciosListos.length}</span>}<span className='pointer' onClick={(e) => { e.preventDefault(); setSelectioned(`seleccionado-SERVICIOS`) }}>ver</span> </span></p>
                                            <p className="flex-p-between"><span> OBRAS</span> <span className="gap-min"><span>PENDIENTES : {rutasMias.seleccionado.obras.length}</span>{!onMobil.state&&<span>TOTAL : {rutasMias.seleccionado.obras.length + rutasMias.seleccionado.obrasListas.length}</span>}<span className='pointer' onClick={(e) => { e.preventDefault(); setSelectioned(`seleccionado-OBRAS`) }}>ver</span> </span></p>
